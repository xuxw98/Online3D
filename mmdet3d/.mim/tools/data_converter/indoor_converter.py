...
def create_indoor_info_file(data_path,
    ...
    # Generate infos for multi-view/online 3D detection (scannet_mv)
    # train/val split for ScanNet, without semantic segmentation information
    if pkl_prefix == 'scannet_mv':
