...
class MinkResNet_Pretrain(BaseModule):
    ...
    def __init__(self,
                 ...
                 pool=True,
                 norm='instance'):
        super(MinkResNet_Pretrain, self).__init__()
    ...
    def init_weights(self):
        state_dict = _load_checkpoint_with_prefix(
            'backbone.', '/home/xxw/3D/Online3D/mmdetection3d/work_dirs/online3d_v0/latest.pth'
        )
