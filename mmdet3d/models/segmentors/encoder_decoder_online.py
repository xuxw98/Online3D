...
class EncoderDecoder3D_Online(Base3DSegmentor):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(EncoderDecoder3D_Online, self).__init__(init_cfg=init_cfg)
    ...
    def forward_train(self, points, img_metas, pts_semantic_mask):
        ...
        for i in range(img_metas[0]['num_frames']):
            ...
            points_cat = torch.stack(current_points)
            pts_semantic_mask_cat = torch.stack(current_pts_semantic_mask)
            ...
            for i in range(len(timestamps)):
                ...
                for j in range(ts_start, ts_end):
                    ...
                    seg_logit = torch.stack([
                        ...
                        for point, img_meta in zip(points_cat, img_metas)
                    ], 0)
                    seg_results[0].append(seg_logit)
