...
class MinkOnline3DDetector_V3(Base3DDetector):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 pretrained=None):
        super(MinkOnline3DDetector_V3, self).__init__(init_cfg)
    ...
    def process_one_frame(self, accumulated_feats, points):
    ...
    def forward_train(self, points, gt_bboxes_3d, gt_labels_3d, box_masks, img_metas):
        """Forward of training.
        ...
        for i in range(img_metas[0]['num_frames']):
            accumulated_feats, current_feats = self.process_one_frame(accumulated_feats, [scene_points[i] for scene_points in points])
            if self.has_neck:
