...
class TD3DInstanceSegmentorFF_Online(Base3DDetector):
    ...
    def forward_train(self, points, modal_box, modal_label, amodal_box, amodal_label,
                     ...
                     img, img_metas):
    #def forward_train(self, points, pts_semantic_mask, pts_instance_mask, gt_bboxes_3d, gt_labels_3d, 
    #                  img, img_metas):
        """Forward of training.
        ...
        for i in range(img_metas[0]['num_frames']):
            ...
            #current_gt_bboxes_3d = gt_bboxes_3d
            #current_gt_labels_3d = gt_labels_3d
            ...
            accumulated_feats, current_feats = self.process_one_frame(accumulated_feats,
                    x,torch.stack(current_img,dim=0),img_metas)
